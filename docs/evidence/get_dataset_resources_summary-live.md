# Evidence: get_dataset_resources_summary (live stdio)

**Date**: 2026-09-03T16:59:25.761Z
...
- `tools/list` returned **21** tools; `get_dataset_resources_summary` present
...
- [x] `tools/list` includes `get_dataset_resources_summary`
...
**PASS** — live stdio call to `get_dataset_resources_summary` succeeded against production API.
